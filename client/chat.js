...
const fillDialog = () => {
  DIALOG = [
    ...
    {question: "Mr. Smith was just here. He wanted to sell me a toaster, again.", answer: "I told you,; to stay away; from him."},
    ...
    {question: "Did you know that in Germany 3214 people died in car accidents in 2016?", answer: "You; only; live; once."},
    {question: "Do you rember the title of the last Batman movie by Christopher Nolan?", answer: "The Dark; Knight; Rises"},
    {question: "What was the movie title based on J. K. Rowling work after the Harry Potter series?", answer: "Fantastic Beasts; and; where; to find them"},
    ...
    {question: "Honey, the computer is broken again. What should I do?", answer: "Have you; tried turning; it off; and on again?"},
    ...
    {question: "What is the greatest film of all time from the UK?", answer: "Monty Python; and; The Holy Grail"},
    ...
    {question: "Did I tell you about...", answer: "Shut up! I'm; trying to; drive; a car; here!"},
    ...
    {question: "Don't look at the phone all the time you idiot!", answer: "I'm; not!"},
    ...
    {question: "My grandma said you deserve loosing your driving licence, you're a horrible driver!", answer: "Adding; insult; to injury."},
    {question: "Did you brush your teeth this morning? Otherwise please do it now!", answer: "I can not; brush my teeth; while driving."},
